...
export const CONTRACTS = {
  ERC20_ADDRESS:
    ...
    "0xbb97f8257cd4ba47ae5c979afcf12eb19d1723e8",
  GAMBLING_ADDRESS:
    (process.env.NEXT_PUBLIC_GAMBLING_CONTRACT_ADDRESS as `0x${string}`) ||
    "0x7d0CF0F993568c38061942f8Eaaa3B2ec084441B",
  CLAIM_ADDRESS:
    (process.env.NEXT_PUBLIC_CLAIM_CONTRACT_ADDRESS as `0x${string}`) ||
    "0xeaded0048371ecc5f93c8cdba0a9c1f147cac695",
} as const;

// ABI for the Claim Contract
