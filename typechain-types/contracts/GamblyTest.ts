...
export interface GamblyTestInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "INITIAL_SUPPLY"
      | "MAX_SUPPLY"
...
export interface GamblyTest extends BaseContract {
  connect(runner?: ContractRunner | null): GamblyTest;
  waitForDeployment(): Promise<this>;

  interface: GamblyTestInterface;
